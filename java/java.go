...
func (j *Module) deps(ctx android.BottomUpMutatorContext) {
	if ctx.Device() {
		...
		if ctx.ModuleName() == "framework" || ctx.ModuleName() == "framework-annotation-proc" {
			...
			ctx.AddDependency(ctx.Module(), arielResTag, "com.arielos.platform-res")
		}
		...
		if ctx.ModuleName() == "com.arielos.platform" ||
			ctx.ModuleName() == "com.arielos.platform.internal" ||
			ctx.ModuleName() == "com.arielos.platform.sdk" {
			ctx.AddDependency(ctx.Module(), arielResTag, "com.arielos.platform-res")
		}
	}
		...
		case Dependency:
			...
			case arielResTag:
				if ctx.ModuleName() == "com.arielos.platform" ||
					ctx.ModuleName() == "com.arielos.platform.internal" ||
					ctx.ModuleName() == "com.arielos.platform.sdk" {
					// com.arielos.platform.jar has a one-off dependency on the R.java and Manifest.java files
					// generated by com.arielos.platform-res.apk
					deps.srcJars = append(deps.srcJars, dep.(*AndroidApp).aaptSrcJar)
				}
				if ctx.ModuleName() == "framework" {
					// framework.jar has a one-off dependency on the R.java and Manifest.java files
